...
Her vocals swing between tender and furious, making every track feel alive and unpredictable.`,
  },
  {
    ...
    rating: 5.0,
    curated: 12,
    image: "https://upload.wikimedia.org/wikipedia/en/d/da/Modal-Soul.jpg",
    bestTracks: ["Luv (Sic) Pt. 3", "Feather", "World's End Rhapsody"],
    tags: ["hip-hop", "instrumental", "jazz-hop"],
    body: `Nujabes' magnum opus sophomore album. A even more well-crafted experience compared to his masterpiece debut. 
...
Blazing horn charts, melodic keys, and slick late-80s rhythm section work—equal parts showy and silky. A hidden gem.`,
  },
  {
    ...
    curated: 6,
    image:
      "https://upload.wikimedia.org/wikipedia/en/e/eb/Gangstarrmomentoftruth.jpg",
    bestTracks: ["Next Time", "JFK 2 LAX", "Work"],
